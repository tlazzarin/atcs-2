...
#v(1em)
Demonstration of the model running on a smartphone using WASM.
#columns(2)[
  #figure(
    image("./5euro.jpg"),
    caption: [5 Euro demo.]
...
The temperature of the PC (called "Host temperature" in the screenshot) is simulated by an #link("https://github.com/DamascenoRafael/mqtt-simulator-config")[MQTT simulator]#footnote(link("https://github.com/DamascenoRafael/mqtt-simulator-config")) with a #link("https://github.com/tlazzarin/atcs-2/blob/main/atcs-tig-stack/mqtt-simulator/settings.json")[custom configuration]#footnote(link("https://github.com/tlazzarin/atcs-2/blob/main/atcs-tig-stack/mqtt-simulator/settings.json")).
